...
export default function InProgress() {
  return (
    <section className="bg-white">
      <div className="mx-auto my-20 max-w-screen-md px-4 py-8 text-center lg:px-12 lg:py-16">
        <svg
          className="mx-auto mb-4 h-10 w-10 text-primary-600"
        ...
        <p className="font-light text-gray-500 md:text-lg xl:text-xl">
          I am currently still working on this page. Come back later!!!
        </p>
        <Link
          to="/"
